...
namespace TheSlum.GameEngine
{
    ...
    public class Engine
    {
        protected List<Character.Character> characterList = new List<Character.Character>();
        ...
        protected void ProcessTargetSearch(Character.Character currentCharacter)
        {
        ...
        protected void ProcessInteraction(Character.Character currentCharacter, Character.Character target)
        {
        ...
        protected Character.Character GetCharacterById(string characterId)
        {
            return this.characterList.FirstOrDefault(x => x.Id == characterId);
        }

        protected Character.Character GetCharacterByItem(Item.Item item)
        {
            return this.characterList.FirstOrDefault(x => x.Inventory.Contains(item));
        }

        protected void PrintCharactersStatus(IEnumerable<Character.Character> characters)
        {
