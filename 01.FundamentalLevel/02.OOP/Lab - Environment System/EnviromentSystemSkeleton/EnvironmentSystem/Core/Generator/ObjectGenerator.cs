namespace EnvironmentSystem.Core.Generator
{
    ...
    public class ObjectGenerator : IObjectGenerator<EnvironmentObject>
    {
        ...
        public IEnumerable<EnvironmentObject> SeedInitialObjects()
        {
            ...
            generatedObjects.Add(new UnstabileStar(0, 1, 1, 1, new Point(2, 1)));
            generatedObjects.Add(new UnstabileStar(25, 1, 1, 1, new Point(1, 2)));
            generatedObjects.Add(new UnstabileStar(24, 1, 1, 1, new Point(2, 2)));
            generatedObjects.Add(new FallingStar(16, 1, 1, 1, new Point(0, 1)));
